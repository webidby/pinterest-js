...
var BOARDS_KEY = 'pinterest-boards';
function getBoards() {
...
function getBoardByName(name) {
  return getBoards().find(function (board) {
    return board.name === name;
  });
}
function addPinToBoard(boardName, pin) {
  var boards = getBoards();
  var board = boards.find(function (b) {
    return b.name === boardName;
  });
  if (board && !board.pins.find(function (p) {
    return p.id === pin.id;
  })) {
    board.pins.push(pin);
    saveBoards(boards);
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        ...
        case 11:
          ...
          console.error('Ошибка при загрузке пинов:', _context.t0);
...
function showBoardSelectionMenu(pin) {
  var boardSelectMenu = document.createElement('div');
  boardSelectMenu.className = 'board-select-menu';
  var boards = (0, _storage.getBoards)();
  boards.forEach(function (board) {
    var boardOption = document.createElement('button');
    boardOption.textContent = board.name;
    boardOption.addEventListener('click', function () {
      (0, _storage.addPinToBoard)(board.name, pin);
      alert("\u041F\u0438\u043D \u0434\u043E\u0431\u0430\u0432\u043B\u0435\u043D \u0432 \u0434\u043E\u0441\u043A\u0443 \"".concat(board.name, "\""));
...
renderBoardOptions();
loadPins();
},{"./storage.js":"storage.js"}],"../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
